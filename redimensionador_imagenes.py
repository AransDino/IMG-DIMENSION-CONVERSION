...
root.geometry("1000x900")  # Change dimensions to 1000x800

# Estilo (simulando Tailwind con ttkthemes)
style = ttk.Style()
style.theme_use("clam")  # Apply the "clam" theme
style.configure("TButton", padding=6, relief="flat", background="orange", foreground="black")  # Set button text color to black
...
style.configure("TFrame", background="#F3F4F6", borderwidth=1, relief="solid")
style.configure("Treeview", background="#FFFFFF", foreground="#1F2937", fieldbackground="#E5E7EB")
style.configure("Treeview.Heading", background="orange", foreground="black")  # This line sets the header color
...
frame_ancho_alto = ttk.Frame(frame_inputs, width=240)
...
frame_referencia_botones = ttk.Frame(frame_inputs, width=560)
...
button_salir = ttk.Button(root, text="Salir", command=salir, style="Exit.TButton")
